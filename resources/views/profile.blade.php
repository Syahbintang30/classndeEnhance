    ...
    <main class="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 space-y-8">
        ...
        <div class="bg-zinc-950/60 border border-white/10 backdrop-blur-3xl rounded-[2rem] p-6 sm:p-8 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
                ...
                <div class="w-20 h-20 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-500 border-2 border-white/20 flex items-center justify-center font-bold text-3xl text-white shadow-xl overflow-hidden shrink-0">
                    @if($avatar)
                        <img src="{{ $avatar }}" alt="{{ auth()->user()->name }}" class="w-full h-full object-cover">
                    @else
