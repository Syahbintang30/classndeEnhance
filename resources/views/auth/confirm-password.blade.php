        ...
        <div class="w-full max-w-[420px] mx-auto animate-float-slow" style="animation-duration: 8s;">
            <div class="bg-zinc-950/60 border border-white/10 backdrop-blur-3xl rounded-[2rem] p-7 sm:p-8 shadow-[0_0_60px_-15px_rgba(59,130,246,0.3)] relative overflow-hidden space-y-5">
                ...
                <div class="text-center space-y-2">
                    ...
                    <h1 class="font-display text-4xl text-white tracking-wide uppercase leading-none">Confirm <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Password</span></h1>
                    <p class="text-gray-400 text-xs leading-relaxed">This is a secure area. Please confirm your password before continuing.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5" x-data="{ show: false }">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" :type="show ? 'text' : 'password'" name="password" required autofocus autocomplete="current-password" placeholder="••••••••" class="w-full bg-zinc-900/80 border border-white/10 rounded-xl pl-11 pr-11 py-3 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/60 focus:ring-2 focus:ring-blue-500/20 transition shadow-inner">
