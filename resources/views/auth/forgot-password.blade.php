            ...
            <div class="bg-zinc-950/60 border border-white/10 backdrop-blur-3xl rounded-[2rem] p-7 sm:p-8 shadow-[0_0_60px_-15px_rgba(59,130,246,0.3)] relative overflow-hidden space-y-5">
                ...
                <div class="text-center space-y-2">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-bold uppercase tracking-widest shadow-inner mb-2">
                        <i class="fa-solid fa-key text-blue-400 text-xs"></i>
                        Account Recovery
                    </div>
                    <h1 class="font-display text-4xl text-white tracking-wide uppercase leading-none">Reset <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Password</span></h1>
                    <p class="text-gray-400 text-xs leading-relaxed">Enter your registered email address and we'll send you a password reset link.</p>
                </div>
